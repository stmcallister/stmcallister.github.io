...
const Talks = () => (
  <div className="row education">
    ...
    <div className="nine columns main-col">
      ...
      <div className="row item">
        <div className="twelve columns">
          <h3>Webhooks aren't as scary as they seem</h3>
          <p className="info">
            API
            <span>&bull;</span>
          </p>
          <p>
            Now that you're comfortable using REST, you really need to keep up with your changing data. The 
            service you're calling provides real-time updates with webhooks, but the constant stream of events 
            seems difficult to grasp. In this talk, we'll make sense out of all the noise. We'll talk about how 
            to initiate webhooks, how to consume them, and talk about strategies for best utilizing them.
          </p>
        </div>
      </div>
      <div className="row item">
